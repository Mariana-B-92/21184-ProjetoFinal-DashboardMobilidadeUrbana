window.dashExtensions = Object.assign({}, window.dashExtensions, {
    default: {
        function0: function(feature, latlng, context) {
            ...
            try {
                (window._giraLayers = window._giraLayers || {})[feature.properties.id_estacao] = _m;
            } catch (e) {}
            return _m;
        },
        function1: function(feature, latlng, context) {
            ...
            try {
                (window._metroLayers = window._metroLayers || {})[feature.properties.id_metro] = _m;
            } catch (e) {}
            return _m;
        },
        function2: function(feature, layer) {
            const p = feature.properties || {};
            if (p.nome_estacao) layer.bindTooltip(p.nome_estacao, {
                direction: 'top'
            });
            ...
            layer.on('popupclose', function() {
                ...
                if (c && c.set_props) {
                    c.set_props('sel-gira', {
                        data: null
                    });
                    c.set_props('sel-metro', {
                        data: null
                    });
                    c.set_props('sel-gira-nome', {
                        value: null
                    });
                    c.set_props('sel-metro-nome', {
                        value: null
                    });
                }
            });
        ...
        function3: function(feature, layer) {
            const p = feature.properties || {};
            if (p.nome_metro) layer.bindTooltip(p.nome_metro, {
                direction: 'top'
            });
