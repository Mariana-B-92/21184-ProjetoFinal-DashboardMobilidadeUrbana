...
# Mapeamento: ficheiro .7z -> nome final do CSV em data/raw/
FICHEIROS = {
...
def preparar():
    for ficheiro, destino in FICHEIROS.items():
        caminho_7z = config.DIR_RAW / ficheiro
        ...
        # Renomeia o CSV extraido para o nome esperado pelo config. os.replace
        # substitui sempre o destino (qualquer SO), refletindo a versao mais
        # recente da fonte (propositado: prototipo extensivel a dados novos).
        for nome in nomes:
